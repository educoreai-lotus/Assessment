...
// Post-course: coding completion forwarder (same persistence as submit-coding-grade)
router.post('/:examId/coding/complete', examsController.completeCodingForExam);
