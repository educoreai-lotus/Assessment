...
export default function QuestionCard({ question, index, total, selected, onAnswer }) {
  ...
  return (
    <div className="dashboard-card bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
      ...
      {isDevLab ? (
        <div>
          ...
          <textarea
            rows={10}
            className="w-full border p-2 rounded font-mono bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 border-gray-300 dark:border-gray-700"
        ...
        <textarea
          rows={4}
          className="w-full border p-2 rounded bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 border-gray-300 dark:border-gray-700"
