...
export default function SkillResultCard({ skillKey, data, defaultThreshold = 70, thresholds = {} }) {
  ...
  return (
    <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-4 mb-4 bg-white dark:bg-gray-800 shadow-sm transition-colors duration-300">
      ...
      <p className={`text-sm mt-1 ${passed ? 'text-green-600 dark:text-green-400' : 'text-amber-600 dark:text-amber-400'}`}>
